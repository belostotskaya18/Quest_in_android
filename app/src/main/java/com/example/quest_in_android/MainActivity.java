    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start_story = new ST(
                ...
                "Вы пришли на экзамен. Вы готовы? \n"
                        ...
                        + "(2) Пожалуй нет.\n",
                2, 0);
        start_story.direction[0] = new ST(
                "Итак, первый вопрос.",
                "Сколько будет 2+2*2? \n"
                        + "(1) 6 \n"
                        + "(2) 8 \n"
                        + "(3) 12\n",
                3, 0);
        start_story.direction[0].direction[0] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Cколько планет в нашей Солнечной Системе? \n"
                        ...
                        + "(3) 12 \n",
                3, 1);
        start_story.direction[0].direction[1] = new ST(
                ...
                "Следующий вопрос: какое максимальное десятичное число можно записать в 1 байт ? \n"
                        ...
                        + "(3) 1024 \n",
                3, 0);
        start_story.direction[0].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ: 6.",
                "Следующий вопрос: назовите цифры двоичной системы счисления. \n"
                        ...
                        + "(3) 0, 1 и 2 \n",
                3, 0);
        start_story.direction[0].direction[0].direction[0] = new ST(
                ...
                3, 0);
        start_story.direction[0].direction[0].direction[1] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Единица измерения силы тока - это? \n"
                        ...
                        + "(3) Ампер \n",
                3, 1);
        start_story.direction[0].direction[0].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ: 8.",
                "Следующий вопрос: Сатурн - это какая планета по счету от Солнца? \n"
                        ...
                        + "(3) 8 \n",
                3, 0);
        start_story.direction[0].direction[1].direction[0] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Какой элемент Периодической системы Д.И. Менделеева обозначается как Ag? \n"
                        ...
                        + "(3) Аргон \n",
                3, 1);
        start_story.direction[0].direction[1].direction[1] = new ST(
                ...
                "Следующий вопрос: Какая самая длинная река в мире? \n"
                        ...
                        + "(3) Янцзы \n",
                3, 0);
        start_story.direction[0].direction[1].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ: 255.",
                "Следующий вопрос: Прискавка 'гекто-' это сколько? \n"
                        ...
                        + "(3) 10 \n",
                3, 0);
        start_story.direction[0].direction[2].direction[0] = new ST(
                ...
                "Следующий вопрос: Сколько хромосом в геноме у человека? \n"
                        ...
                        + "(3) 46 \n",
                3, 0);
        start_story.direction[0].direction[2].direction[1] = new ST(
                "Да, правильно!",
                "Следующий вопрос: В каком году люди впервые высадились на Луну? \n"
                        ...
                        + "(3) 1958 \n",
                3, 1);
        start_story.direction[0].direction[2].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ: 1 и 0.",
                "Следующий вопрос: Сколько существует законов Ньютона? \n"
                        ...
                        + "(3) 1 \n",
                3, 0);
        start_story.direction[0].direction[0].direction[0].direction[0] = new ST(
                ...
                "Следующий вопрос: Сколько всего на нашей планете океанов? \n"
                        ...
                        + "(3) 6 \n",
                0, 0);
        start_story.direction[0].direction[0].direction[0].direction[1] = new ST(
                "К сожалению не правильно. Правильный ответ : правильного ответа нет.",
                "Следующий вопрос: Столица Австралии? \n"
                        ...
                        + "(3) Мельбурн \n",
                0, 0);
        start_story.direction[0].direction[0].direction[0].direction[2] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Сколько материков на наше1 планете? \n"
                        ...
                        + "(3) 5 \n",
                0, 1);
        start_story.direction[0].direction[0].direction[1].direction[0] = new ST(
                ...
                "Следующий вопрос: Кто такой Никола Тэсла? \n"
                        ...
                        + "(3) Математик \n",
                0, 0);
        start_story.direction[0].direction[0].direction[1].direction[1] = new ST(
                "К сожалению не правильно. Правильный ответ : Ампер.",
                ...
                0, 0);
        start_story.direction[0].direction[0].direction[1].direction[2] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Сколько зубов у человека? \n"
                        ...
                        + "(3) 31 \n",
                0, 1);
        start_story.direction[0].direction[0].direction[2].direction[0] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Чему ровно число «Пи»? \n"
                        ...
                        + "(3) 1.07 \n",
                0, 1);
        start_story.direction[0].direction[0].direction[2].direction[1] = new ST(
                "К сожалению не правильно. Правильный ответ : 6.",
                "Следующий вопрос: Кто написал «Мастера и Маргариту»? \n"
                        ...
                        + "(3) Грибоедов \n",
                0, 0);
        start_story.direction[0].direction[0].direction[2].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ : 6.",
                "Следующий вопрос: Как называется прямая, ограниченная точками? \n"
                        ...
                        + "(3) прямая \n",
                0, 0);
        start_story.direction[0].direction[1].direction[0].direction[0] = new ST(
                ...
                "Следующий вопрос: Какова температура замерзания воды? \n"
                        ...
                        + "(3) 1 \n",
                0, 0);
        start_story.direction[0].direction[1].direction[0].direction[1] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Как выглядит символ натрия? \n"
                        ...
                        + "(3) Ca \n",
                0, 1);
        start_story.direction[0].direction[1].direction[0].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ : Серебро.",
                "Следующий вопрос: Сколько известных человеку химических элементов? \n"
                        ...
                        + "(3) 114 \n",
                0, 0);
        start_story.direction[0].direction[1].direction[1].direction[0] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Жанр произведения А.С. Пушкина `Няне`? \n"
                        ...
                        + "(3) стих \n",
                0, 1);
        start_story.direction[0].direction[1].direction[1].direction[1] = new ST(
                ...
                "Следующий вопрос: Что меньше: 40 центнеров или 4 тонны?\n"
                        ...
                        + "(3) одинаково \n",
                0, 0);
        start_story.direction[0].direction[1].direction[1].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ : Амазонка.",
                "Следующий вопрос: Цветы, собранные в пучок? \n"
                        ...
                        + "(3) клумба \n",
                0, 0);
        start_story.direction[0].direction[1].direction[2].direction[0] = new ST(
                ...
                "Следующий вопрос: Цветы, собранные в пучок? \n"
                        ...
                        + "(3) клумба \n",
                0, 0);
        start_story.direction[0].direction[1].direction[2].direction[1] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Цветы, собранные в пучок? \n"
                        + "(1) букет \n"
                        + "(2) веник \n"
                        + "(3) клумба \n",
                0, 1);
        start_story.direction[0].direction[1].direction[2].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ : 100.",
                "Следующий вопрос: Цветы, собранные в пучок? \n"
                        + "(1) букет \n"
                        + "(2) веник \n"
                        + "(3) клумба \n",
                0, 0);
        start_story.direction[0].direction[2].direction[0].direction[0] = new ST(
                ...
                "Следующий вопрос: Жанр произведения А.С. Пушкина `Няне`? \n"
                        ...
                        + "(3) стих \n",
                0, 0);
        start_story.direction[0].direction[2].direction[0].direction[1] = new ST(
                "К сожалению не правильно. Правильный ответ : 46.",
                "Следующий вопрос: Жанр произведения А.С. Пушкина `Няне`? \n"
                        + "(1) сказка \n"
                        + "(2) рассказ \n"
                        + "(3) стих \n",
                0, 0);
        start_story.direction[0].direction[2].direction[0].direction[2] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Жанр произведения А.С. Пушкина `Няне`? \n"
                        + "(1) сказка \n"
                        + "(2) рассказ \n"
                        + "(3) стих \n",
                0, 1);
        start_story.direction[0].direction[2].direction[1].direction[0] = new ST(
                ...
                "Следующий вопрос: Как называется прямая, ограниченная точками? \n"
                        ...
                        + "(3) прямая \n",
                0, 0);
        start_story.direction[0].direction[2].direction[1].direction[1] = new ST(
                "Да, правильно!",
                "Следующий вопрос: Как называется прямая, ограниченная точками? \n"
                        + "(1) отрезок \n"
                        + "(2) луч \n"
                        + "(3) прямая \n",
                0, 1);
        start_story.direction[0].direction[2].direction[1].direction[2] = new ST(
                "К сожалению не правильно. Правильный ответ : 1969.",
                "Следующий вопрос: Как называется прямая, ограниченная точками? \n"
                        + "(1) отрезок \n"
                        + "(2) луч \n"
                        + "(3) прямая \n",
                0, 0);
        start_story.direction[1] = new ST(
                "Хм...",
        ...
        b[0].setOnClickListener(new Listner(this,0));
        b[1].setOnClickListener(new Listner(this, 1));
        b[2].setOnClickListener(new Listner(this, 2));
